/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8ac7d1c959d0e5a43c5e76ac15307f9)
// Runtime types generated with workerd@1.20250712.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		"gomail-kv": KVNamespace;
		SESSION_SECRET: string;
		BAIDU_ANALYTICS_ID: string;
		ENABLE_ANALYTICS: string;
		"gomail-attachments": R2Bucket;
		DB: D1Database;
		"aug.qzz.io": SendEmail;
	}
}
